...
class AddScreenDare extends StatefulWidget {
  static const String id = 'add_screen_dare';

  @override
  _AddScreenState createState() => _AddScreenState();
}

class _AddScreenState extends State<AddScreenDare> {
      ...
      body: Column(
        ...
        children: <Widget>[
          Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: <Widget>[
              /*Hero(tag: 'adddare', child: */ CustomAppBar(
                  'add_dare_title') /*)*/,
              Container(
                  ...
                  children: <Widget>[
                        ...
                        child: TextField(
                          ...
                          onSubmitted: (text) async {
                            ...
                            if (text != null) {
                              ...
                              Dare newDare = Dare(title: text);
                              await DBProviderDare.db.newClient(newDare);
                    ...
                    onPressed: () async {
                      ...
                      if (newDataTitle != null) {
                        Dare dare = Dare(title: newDataTitle);
                        await DBProviderDare.db.newClient(dare);
                                  ...
                                  Container(
                                    child: IconButton(
                                      icon: Icon(Icons.delete_forever,
                                          color: kLightGrey),
                                      onPressed: () {
                                        DBProviderDare.db.deleteClient(item.id);
                                        setState(() {});
                                      },
                                    ),
                                  )
